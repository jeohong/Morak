...
struct EditPostView: View {
    ...
    init(postId: Int, initialContent: String, onPostUpdated: (() -> Void)? = nil) {
        self.initialContent = initialContent
        self.onPostUpdated = onPostUpdated
        _viewModel = StateObject(wrappedValue: EditPostViewModel.makeDefault(postId: postId, initialContent: initialContent))
    }
    ...
    var body: some View {
        ...
        .onChange(of: viewModel.isPostUpdated) { isUpdated in
            if isUpdated {
                onPostUpdated?()
                dismiss()
            }
    ...
    private func handleBackButton() {
        if viewModel.content != initialContent {
